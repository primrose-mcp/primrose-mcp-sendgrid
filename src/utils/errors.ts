 ...
 *
 * Custom error classes and error handling helpers for SendGrid API.
 */

/**
 * Base SendGrid API error
 */
 ...
 */
export class RateLimitError extends SendGridApiError {
 ...
 */
export class AuthenticationError extends SendGridApiError {
 ...
 * Not found error
 */
export class NotFoundError extends SendGridApiError {
 ...
 * Validation error
 */
export class ValidationError extends SendGridApiError {
